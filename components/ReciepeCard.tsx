...
const RecipeCards = ({ recipes, search }: RecipeGridProps) => {
  ...
  return (
    <div className=' grid grid-cols-1 lg:grid-cols-3 items-full  space-y-3 gap-6  h-full  '>
  ...
  return (
    <div className='rounded-2xl  shadow-xs flex flex-col p-2 gap-2 h-full bg-[#FFFFFF]'>
      <div className='recipeItem  flex  flex-col wrap'>
        <div className='recipeImage w-full '>
          <Image className='hidden md:block object-cover rounded' src={image.large} alt="Recipe Image" width={1024} height={1024} />
          <Image className='md:hidden object-cover rounded ' src={image.small} alt="Recipe Image" width={500} height={500} />
        </div>
